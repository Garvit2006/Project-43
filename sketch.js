...
function setup(){
  ...
  ground1 = new Ground(690,displayHeight/2+170,20,10);
  ground2 = new Ground(displayWidth/2+60,displayHeight/2+165,20,10);
  ground3 = new Ground(displayWidth/2+70,displayHeight/2+160,20,10);
  ground4 = new Ground(displayWidth/2+80,displayHeight/2+155,20,10);
  ground5 = new Ground(displayWidth/2+40,displayHeight/2+165,20,10);
  ground6 = new Ground(displayWidth/2+30,displayHeight/2+160,20,10);
  ground7 = new Ground(displayWidth/2+20,displayHeight/2+155,20,10);
  ground8 = new Ground(displayWidth/2+30,displayHeight/2+155,20,10);
